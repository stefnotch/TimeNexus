...
namespace SiliconStudio.Xenko.Rendering
{
    ...
    {
        internal partial class XenkoLighting1  : IShaderMixinBuilder
        {
            ...
            {
                ShaderMixinManager.Register("XenkoLighting1", new XenkoLighting1());
            }
        }
    }
    internal static partial class ShaderMixins
    {
        internal partial class Shader1  : IShaderMixinBuilder
        {
            public void Generate(ShaderMixinSource mixin, ShaderMixinContext context)
            {
                ...
                context.Mixin(mixin, "XenkoLighting1");
            ...
            {
                ShaderMixinManager.Register("Shader1", new Shader1());
            }
        }
    }
}
