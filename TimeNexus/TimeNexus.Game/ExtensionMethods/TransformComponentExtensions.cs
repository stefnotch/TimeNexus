...
namespace TimeNexus.ExtensionMethods
{
	...
	public static class TransformComponentExtensions
	{
		...
		{
			Vector3 position;
			transformComponent.GetWorldTransformation(out position, out _, out _);
			return position;
		}
		...
		{
			Quaternion rotation;
			transformComponent.GetWorldTransformation(out _, out rotation, out _);
			return rotation;
		}
		...
		{
			Vector3 scale;
			transformComponent.GetWorldTransformation(out _, out _, out scale);
			return scale;
		}


		//The following code isn't mine:
...
Licensed under the Apache License, Version 2.0 (the "License");
   ...
   */
		...
		private static class MathUtilEx
		{
